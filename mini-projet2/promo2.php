...
<body>
    ...
    <?php
    if ((isset($_POST['code']) && $_POST['code'] == 'xxy') and 
    (isset($_POST['nom']) && $_POST['nom'] == 'entrant') and 
    (isset($_POST['mois']) && $_POST['mois'] == 'avril') and 
    (isset($_POST['an']) && $_POST['an'] == '2019')
    ) {

        echo "<h1>Liste des apprenants</h1>";

        $fichier = 'promo2.txt'; // fichier
    ...
    <div id="menu">
        <ul>
            <li><a href="modpromo2.php">Modification</a></li>
            <li><a href="exclupromo2.php">Exclusion</a></li>
            <li><a href="inscripromo2.php">Inscription</a></li>
        </ul>
    </div>
